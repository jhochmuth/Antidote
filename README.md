...
NOTE: This extension will not work with the [changes](https://www.chromium.org/Home/chromium-security/extension-content-script-fetches) that Google made in regards to CORS and chrome extensions. 
